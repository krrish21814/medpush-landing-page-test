...
const Footer = () => {
    ...
    return (
        <footer className="bg-gradient-to-r from-white via-[#FFF0F1] to-[#FFD6DC]">
            <div className="max-w-[1400px] mx-auto px-4 md:px-6 lg:px-8 py-12 md:py-16 lg:py-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-10 gap-8 md:gap-10 lg:gap-12 mb-8 md:mb-10">
                    ...
                    <div className="lg:col-span-6 grid grid-cols-1 sm:grid-cols-3 gap-8 md:gap-10 lg:gap-12">
                        {/* Quick Links */}
                        <div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-10 gap-8 md:gap-10 lg:gap-12">
                    {/* Social Media */}
                    <div className="lg:col-span-4 border-t border-gray-300 pt-6 md:pt-8 lg:pt-10">
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                            ...
                            <div className="flex gap-3">
                                ...
                                <a href="#" className="w-10 h-10 md:w-12 md:h-12 bg-gray-900 hover:bg-[#C11E2B] text-white rounded-full flex items-center justify-center transition-all duration-200" aria-label="LinkedIn">
