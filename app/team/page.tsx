        ...
        <div className="min-h-screen bg-white">
            ...
            <section className="relative w-full h-[180px] md:h-[240px] overflow-hidden mt-16 md:mt-24">
                ...
                <div className="relative z-10 h-full flex items-center justify-center px-4">
                    <h1 className="text-white text-3xl md:text-5xl lg:text-6xl font-bold text-center">Our Team</h1>
                </div>
            </section>

            {/* Team Members Section */}
            <section className="max-w-[1400px] mx-auto px-4 md:px-8 py-10 md:py-16 lg:py-20">
                <h2 className="text-2xl md:text-3xl font-bold text-center text-[#C11E2B] mb-10 md:mb-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
                    {currentMembers.map((member, idx) => (
                        <div
                            ...
                            className="relative rounded-2xl overflow-hidden hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 cursor-pointer group"
                        >
